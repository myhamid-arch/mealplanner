...
const GATES = {
  ...
  G3: {
    ...
    required: [
      "G3 on F1 the registry is exactly the AGT-6 v1 ops plus the BLD-8 R-10 and R-24 ops",
      "G3 on F3 the registry is exactly the AGT-6 v1 ops plus the BLD-8 R-10 and R-24 ops",
      ...
      "F1: portion_bias.set refuses a targeted member",
      "F3: portion_bias.set refuses a targeted member",
